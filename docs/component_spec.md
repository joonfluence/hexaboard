...
`apps/web`의 UI 컴포넌트 명세다. 확정된 결정에서 옮긴 내용만 "확정"으로 적는다. `apps/web`은 기능 005에서 구현한다. 12개 모두 구현했다(기능 005·009).
...
UI 관련 미결은 [open_questions.md](open_questions.md#ui)를 본다("현재 미결 항목 없음").
